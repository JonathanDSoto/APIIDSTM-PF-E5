...
document.getElementById("layout-menu") &&
        ...
        var a,
            ...
            n =
                (window.templateCustomizer &&
                    ...
                    (n = n.querySelector("i")),
                    "light" === s
                        ? (n.classList.add("ti-sun"),
                          new bootstrap.Tooltip(n, {
                              title: "Light Mode",
                              fallbackPlacements: ["bottom"],
                          }))
                        : "dark" === s
                        ? (n.classList.add("ti-moon"),
                          new bootstrap.Tooltip(n, {
                              title: "Dark Mode",
                              fallbackPlacements: ["bottom"],
                          }))
    ...
    "undefined" != typeof $ &&
        $(function () {
            ...
            n.length &&
                n.on("click", function () {
                    s.length && (s.toggleClass("d-none"), o.focus());
                }),
                $(document).on("keydown", function (e) {
                    var t = e.ctrlKey,
                        e = 191 === e.which;
                    t && e && s.length && (s.toggleClass("d-none"), o.focus());
                }),
                setTimeout(function () {
                    var e = $(".twitter-typeahead");
                    o.on("focus", function () {
                        s.hasClass("container-xxl")
                            ? (s.find(e).addClass("container-xxl"),
                              e.removeClass("container-fluid"))
                            : s.hasClass("container-fluid") &&
                              (s.find(e).addClass("container-fluid"),
