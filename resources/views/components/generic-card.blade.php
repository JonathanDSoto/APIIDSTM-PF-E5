<div class="card col p-0 shadow position-relative" style="width: 18rem">
    <div class="dropdown position-absolute end-0">
        <button class="btn btn-primary p-1" id="actions" data-bs-toggle="dropdown" type="button" data-bs-display="static">
    ...
    <img src="{{ asset('assets/img/machape/fail.png') }}" class="card-img-top" alt="Image of {{ $title }}" />
    <div class="card-body">
